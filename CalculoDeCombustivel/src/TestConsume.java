...
public class TestConsume {
    public static void main(String[] args) {
        ...
        CalculoDeConbustivel consumo = new CalculoDeConbustivel();

        Scanner entrada = new Scanner(System.in);

        double VelocipedeMedia, TempoGasto, Autonomia = 12; //Velocidade média em Km/h, Tempo gasto em horas e autonomia em Km/L
        ...
        VelocipedeMedia = entrada.nextDouble();


        Distancia = VelocipedeMedia * TempoGasto;
        LitrosUsados = Distancia / Autonomia;


        System.out.print("\n\n\nResultados:\n\n");
        System.out.print("Velocidade média = " + VelocipedeMedia + " Km/h\n");
